...
public class CreateGhostTableAction implements Action<OscActionContext, OscActionResult> {
    ...
    private void validateColumnDifferent(OnlineSchemaChangeScheduleTaskParameters taskParam,
        ...
        if (!aMinusB.isEmpty()) {
            ...
            log.info("drop column found for osc task, database = {}, origin table name = {}, new table name = {}, drop columns = {}", taskParam.getDatabaseName(), taskParam.getOriginTableName(), taskParam.getNewTableName(), aMinusB);
        }
