...
public class RemoteTaskSupervisorProxy implements TaskSupervisorProxy {
    ...
    public ExecutorEndpoint startTask(SupervisorEndpoint supervisorEndpoint, JobContext jobContext,
        ...
        return JsonUtils.fromJson(taskCommandSender.sendCommand(supervisorEndpoint, StartTaskCommand.create(jobContext, processConfig)), ExecutorEndpoint.class);
    }

    @Override
    public boolean stopTask(SupervisorEndpoint supervisorEndpoint, ExecutorEndpoint executorEndpoint,
        JobContext jobContext) {
        return Boolean.valueOf(taskCommandSender.sendCommand(supervisorEndpoint, GeneralTaskCommand.create(jobContext, executorEndpoint, CommandType.STOP)));
    }

    @Override
    public boolean modifyTask(SupervisorEndpoint supervisorEndpoint, ExecutorEndpoint executorEndpoint,
        JobContext jobContext) {
        return Boolean.valueOf(taskCommandSender.sendCommand(supervisorEndpoint, GeneralTaskCommand.create(jobContext, executorEndpoint, CommandType.MODIFY)));
    }

    @Override
    public boolean finishTask(SupervisorEndpoint supervisorEndpoint, ExecutorEndpoint executorEndpoint,
        JobContext jobContext) {
        return Boolean.valueOf(taskCommandSender.sendCommand(supervisorEndpoint, GeneralTaskCommand.create(jobContext, executorEndpoint, CommandType.FINISH)));
    }

    @Override
    public boolean canBeFinished(SupervisorEndpoint supervisorEndpoint, ExecutorEndpoint executorEndpoint,
        JobContext jobContext) {
        return Boolean.valueOf(taskCommandSender.sendCommand(supervisorEndpoint, GeneralTaskCommand.create(jobContext, executorEndpoint, CommandType.CAN_BE_FINISHED)));
    }
