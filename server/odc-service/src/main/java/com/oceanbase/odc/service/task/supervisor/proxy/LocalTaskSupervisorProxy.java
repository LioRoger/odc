...
public class LocalTaskSupervisorProxy implements TaskSupervisorProxy{
    ...
    public ExecutorEndpoint startTask(SupervisorEndpoint supervisorEndpoint, JobContext jobContext,
        ...
        if (isLocalCommandCall(supervisorEndpoint)) {
            log.info("local call start task, supervisorEndpoint={}, jobContext={}, processConfig={}", supervisorEndpoint, jobContext, processConfig);
            return localTaskSupervisor.startTask(jobContext, processConfig);
        } else {
            log.info("remote call start task, supervisorEndpoint={}, jobContext={}, processConfig={}", supervisorEndpoint, jobContext, processConfig);
    ...
    public boolean stopTask(SupervisorEndpoint supervisorEndpoint, ExecutorEndpoint executorEndpoint,
        ...
        if (isLocalCommandCall(supervisorEndpoint)) {
            log.info("local call stop task, supervisorEndpoint={}, executorEndpoint={}, jobContext={}", supervisorEndpoint, executorEndpoint, jobContext);
            return localTaskSupervisor.stopTask(executorEndpoint, jobContext);
        } else {
            log.info("remote call stop task, supervisorEndpoint={}, executorEndpoint={}, jobContext={}", supervisorEndpoint, executorEndpoint, jobContext);
    ...
    public boolean modifyTask(SupervisorEndpoint supervisorEndpoint, ExecutorEndpoint executorEndpoint,
        JobContext jobContext) {
        if (isLocalCommandCall(supervisorEndpoint)) {
            log.info("local call modify task, supervisorEndpoint={}, executorEndpoint={}, jobContext={}", supervisorEndpoint, executorEndpoint, jobContext);
            return localTaskSupervisor.modifyTask(executorEndpoint, jobContext);
        } else {
            log.info("remote call modify task, supervisorEndpoint={}, executorEndpoint={}, jobContext={}", supervisorEndpoint, executorEndpoint, jobContext);
    ...
    public boolean finishTask(SupervisorEndpoint supervisorEndpoint, ExecutorEndpoint executorEndpoint,
        JobContext jobContext) {
        if (isLocalCommandCall(supervisorEndpoint)) {
            log.info("local call finish task, supervisorEndpoint={}, executorEndpoint={}, jobContext={}", supervisorEndpoint, executorEndpoint, jobContext);
            return localTaskSupervisor.finishTask(executorEndpoint, jobContext);
        } else {
            log.info("remote call finish task, supervisorEndpoint={}, executorEndpoint={}, jobContext={}", supervisorEndpoint, executorEndpoint, jobContext);
    ...
    public boolean canBeFinished(SupervisorEndpoint supervisorEndpoint, ExecutorEndpoint executorEndpoint,
        JobContext jobContext) {
        if (isLocalCommandCall(supervisorEndpoint)) {
            log.info("local call canBeFinished task, supervisorEndpoint={}, executorEndpoint={}, jobContext={}", supervisorEndpoint, executorEndpoint, jobContext);
            return localTaskSupervisor.canBeFinished(executorEndpoint, jobContext);
        } else {
            log.info("remote call canBeFinished task, supervisorEndpoint={}, executorEndpoint={}, jobContext={}", supervisorEndpoint, executorEndpoint, jobContext);
