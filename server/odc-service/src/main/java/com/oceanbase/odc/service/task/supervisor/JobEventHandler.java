...
public interface JobEventHandler {
     ...
     * @param jobContext
     */
    void afterStartJob(ExecutorIdentifier executorIdentifier, JobContext jobContext) throws JobException;
     ...
     * @param jobContext
     */
    void afterFinished(ExecutorIdentifier executorIdentifier, JobContext jobContext) throws JobException;

    /**
     * target machine may offline
     * @param jobContext
     */
    void finishFailed(ExecutorIdentifier executorIdentifier, JobContext jobContext);
