...
public abstract class TaskCommand {
    ...
    protected static final int COMMAND_VERSION = 0;
    protected static final String VERSION_NAME = "version";
    protected static final String JOB_CONTEXT_NAME = "jobContext";
    protected static final String COMMAND_TYPE_NAME = "command";
    @Getter
    ...
    public String serialize() {
        ...
        jsonNode.put(COMMAND_TYPE_NAME, commandType().toString());
        append(jsonNode);
    ...
    protected void fillCommonFields(JsonNode jsonNode) {
        ...
        jobContext = jobContextNode == null ? null : JsonUtils.fromJson(jobContextNode.asText(), JobContext.class);
    }
