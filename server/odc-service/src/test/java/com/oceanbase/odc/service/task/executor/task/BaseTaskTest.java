        ...
        try (MockedStatic<SystemUtils> mockSystemUtil = Mockito.mockStatic(SystemUtils.class)) {
            ...
            dummyBaseTask.start(new TaskContext() {
                ...
                public SharedStorage getSharedStorage() {
                    return Mockito.mock(SharedStorage.class);
                }
            });
            TaskResult taskResult = TaskResultBuilder.build(dummyBaseTask);
            TaskResultBuilder.assignErrorMessage(taskResult, dummyBaseTask);
